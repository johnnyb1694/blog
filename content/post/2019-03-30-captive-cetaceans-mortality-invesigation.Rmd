---
title: 'Captive Cetaceans - Mortality Investigation'
author: Johnny Breen
date: '2019-03-30'
slug: captive-cetaceans-mortality-investigation
categories:
  - R
tags:
  - R Markdown
...
So, here it is: my first ever contribution to the [TidyTuesday](https://github.com/rfordatascience/tidytuesday) project hosted on github! In this post, I am going to analyse a dataset on various cetacean species, originally analysed by Amber Thomas in an [excellent Pudding article](https://pudding.cool/2017/07/cetaceans/). Although this dataset is a less recent submission, I chose it because I was interested to learn a bit about the history of cetacean captivity and also their potential future in the context of climate risk. Incase, like me, you don't know what a 'cetacean' is, it collectively refers to species such as dolphins and whales.
