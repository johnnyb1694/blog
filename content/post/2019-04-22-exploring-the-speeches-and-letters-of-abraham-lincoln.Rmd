---
title: Exploring the speeches and letters of Abraham Lincoln
author: Johnny Breen
date: '2019-04-22'
slug: exploring-the-speeches-and-letters-of-abraham-lincoln
categories:
  - Data Science
  - R
tags:
...
```{r include=FALSE}
lincoln_raw <- readRDS("~/Desktop/misc./lincoln.RData")
```
...
Still, with over 1,000 words in each year category there is perhaps some evidence that such writings may have reflected truly genuine emotional concerns on Lincoln's part. I'm particularly curious about what on earth happened during 1841 and 1843:
...
I did a little more digging online about the letters Lincoln wrote during 1841 and came across the following letter to John Stuart (a prominent lawyer in the USA at the time), the content of which appears to match the printout above:

```{r echo=FALSE, fig.cap="Lincoln's letter to John Stuart", out.width = '100%'}
knitr::include_graphics("/Users/Johnny/Desktop/Misc./Lincoln_To_Stuart.png")
```

According to [this source](http://housedivided.dickinson.edu/sites/lincoln/letter-to-john-stuart-january-23-1841/), the cause of Lincoln's depression at the time "resulted entirely from the situation he . . . got himself into – he was engaged to Miss Todd, and in love with Miss Edwards, and his conscience troubled him dreadfully for the supposed injustice he had done, and the supposed violation of his word which he had committed".
